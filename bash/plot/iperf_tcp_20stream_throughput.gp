...
outputular=sprintf("iperf_tcp_20stream_%s_throughput.png", ARG1)
set output outputular
titular=sprintf("iPerf3 TCP Throughput - 20 sessions - %s", ARG1)
set title titular
set size 1,0.6
set grid y
set xlabel "Time (s)"
...
filename=sprintf("../../results/results/tsv/%s/iperf_tcp_20stream_bandwidth_stats.tsv", ARG1)
