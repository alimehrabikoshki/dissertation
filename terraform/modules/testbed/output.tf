...
output "cluster3-master-ip" {
  value = module.provision-regionB-cluster.1.master-node-ip
}
output "cluster3-worker1-ip" {
  value = module.provision-regionB-cluster.1.worker1-node-ip
}
output "cluster3-worker2-ip" {
  value = module.provision-regionB-cluster.1.worker2-node-ip
}
output "cluster3-master-public-ip" {
  value = module.provision-regionB-cluster.1.master-node-public-ip
}
output "cluster3-worker1-public-ip" {
  value = module.provision-regionB-cluster.1.worker1-node-public-ip
}
output "cluster3-worker2-public-ip" {
  value = module.provision-regionB-cluster.1.worker2-node-public-ip
}
